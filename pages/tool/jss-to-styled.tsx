    ...
    <Box>
      ...
      >
        ...
        <DialogContent>
          ...
          <Typography mb={2}>
            You need to copy <b>JSS</b> and <b>JSX</b> from your js file to the
            inputs. This tool will start looking at the JSS and map the keys
            with JSX that your provide. If JSS and JSX is valid, you will see
            the result on the right which contains 2 section, the styled
          ...
          >
            ...
            {!result.jsx && !result.styledComponents && (
              <Box p={2} color="grey.400">
                Once valid JSS and JSX is provided on the left, the result will
                appear here.
              </Box>
            )}
            {result.styledComponents && (
